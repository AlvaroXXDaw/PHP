...
function getResultados()
{
	...
	$sentencia = "select local.equipo as local , visitante.equipo as visitante, marcador_local , marcador_visitante, estado from liga_partidos, liga_equipos as local, liga_equipos as visitante where liga_partidos.local_id = local.equipo_id and liga_partidos.visitante_id = visitante.equipo_id and jornada_id = ? order by partido_id";
	$resultado  = $GLOBALS['DB']->prepare($sentencia);
